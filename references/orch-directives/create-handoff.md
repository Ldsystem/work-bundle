---
name: create-handoff
description: 'Create orchestration or executor handoff files for continuing work across conversations, agents, or implementation execution cycles.'
---

# Create Handoff

Create a handoff for `${input:HandoffPurpose}` that lets the next agent continue without previous conversation context.
