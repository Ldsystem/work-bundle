...
4. Carry execution-workspace isolation, hydration, and cleanup policy into task and executor context; overlapping mutating siblings isolate via prepare_worktree or serialize.
