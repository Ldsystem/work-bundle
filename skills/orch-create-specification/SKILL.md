...
4. Classify results as authority, candidate, background, or blocked. Only authority shapes requirements. Keep supporting, opposing, constraining, unresolved/open-question, obsolete, and irrelevant-with-reason evidence visible when material. Downstream artifacts carry accepted authority so execution does not require `.work-bundle/knowledge/` reads.
