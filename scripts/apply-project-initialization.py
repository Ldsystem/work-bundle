...
def main():
    ...
    ap.add_argument('--github-remote')
    ap.add_argument('--default-branch')
    ap.add_argument('--technology-stack-seed')
    ap.add_argument('--industry-domain-seed')
    ap.add_argument('--create-project-skill-override', action='store_true')
    ap.add_argument('--disable-work-bundle-git', action='store_true')
    ...
    changed = apply_model(pr, init_git=not args.disable_work_bundle_git, create_override=args.create_project_skill_override)
    ok, data = validate(pr)
